...
class InceptionBCAM(nn.Module):
    def __init__(self, num_classes=1000, large_feature_map=False, num_head=100, dataset_name="CUB", **kwargs):
        super(InceptionBCAM, self).__init__()
        ...
        self.aggregator_A = nn.Conv2d(1024, num_head, 1, bias=False)
        self.aggregator_B = nn.Conv2d(1024, num_head, 1, bias=False)
