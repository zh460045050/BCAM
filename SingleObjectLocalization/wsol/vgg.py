...
class VggBCAM(nn.Module):
    def __init__(self, features, num_classes=1000, num_head=100, **kwargs):
        super(VggBCAM, self).__init__()
        ...
        self.aggregator_A = nn.Conv2d(512, num_head, 1, bias=True)
        self.aggregator_B = nn.Conv2d(512, num_head, 1, bias=True)

        self.classifier_A = nn.Conv2d(1024, num_classes, 1, 1, padding=0)
        self.classifier_B = nn.Conv2d(1024, num_classes, 1, 1, padding=0)
    ...
    def forward(self, x, labels=None, return_cam=False):
        ...
        label_back_rev = label_back_rev.view(label_back_rev.size(0), -1)
